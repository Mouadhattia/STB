...
import volet from "./volet.png";
import valeur from "./valeur politique.png";
import a from "./1.png";
import b from "./2.png";
import c from "./3.png";
import d from "./4.png";
...
const Responsabilte = () => {
  ...
  return (
    <>
      <MainLayout>
        <HeaderBackground />
        <h1 className="page-title">Responsabilité Sociale</h1>
        <div className="responsabilte">
          <div className="politique">
            ...
            <img src={valeur} alt="" width="100%" className="valeurImage" />
          </div>

          <div className="pour_nos_participations">
            <h3>Pour Notre Participation</h3>
            <p className="page-description">
            ...
            <div className="voletDiv">
              <img src={volet} alt="" width="50%" />
            </div>
          </div>
          <div className="contribution_Odd">
            <h3>Contribution ODD</h3>
            <p className="page-description">
